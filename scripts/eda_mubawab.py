...
raw_files = glob.glob("processed/tunisia_real_estate_mubawab_raw.csv")
if not raw_files:
    raw_files = glob.glob("output/mubawab_max_*.csv")
if not raw_files:
    print("No raw CSV found. Run prepare_mubawab.py first!")
    exit()
